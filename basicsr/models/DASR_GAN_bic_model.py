...
class DASR_GAN_bic_Model(SRGANModel):
    def __init__(self, opt):
        super(DASR_GAN_bic_Model, self).__init__(opt)
    ...
    def nondist_validation(self, dataloader, current_iter, tb_logger, save_img):
        ...
        self.is_train = False
        super(DASR_GAN_bic_Model, self).nondist_validation(dataloader, current_iter, tb_logger, save_img)
        self.is_train = True
