...
class DASR_sGANModel(SRGANModel):

    def __init__(self, opt):
        super(DASR_sGANModel, self).__init__(opt)
    ...
    def nondist_validation(self, dataloader, current_iter, tb_logger, save_img):
        ...
        self.is_train = False
        super(DASR_sGANModel, self).nondist_validation(dataloader, current_iter, tb_logger, save_img)
        self.is_train = True
