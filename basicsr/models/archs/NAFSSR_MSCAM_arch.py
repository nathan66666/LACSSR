...
class NAFSSR_MSCAM(Local_Base, NAFNetSR):
...
if __name__ == '__main__':
    ...
    net = NAFSSR_MSCAM(up_scale=2,train_size=train_size, fast_imp=True, width=width, num_blks=num_blks, drop_path_rate=droppath)
