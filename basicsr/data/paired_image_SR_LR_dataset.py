...
class PairedImageSRLRDataset_(data.Dataset):
    ...
    def __init__(self, opt):
        super(PairedImageSRLRDataset_, self).__init__()
        self.opt = opt
    ...
    def __getitem__(self, index):
        ...
        gt_path_L = os.path.join(self.gt_folder, '{:04}_L.jpg'.format(index + 1))
        gt_path_R = os.path.join(self.gt_folder, '{:04}_R.jpg'.format(index + 1))
        ...
        lq_path_L = os.path.join(self.lq_folder, '{:04}_L.jpg'.format(index + 1))
        lq_path_R = os.path.join(self.lq_folder, '{:04}_R.jpg'.format(index + 1))
